				...
				<ul class="side-menu">
					...
					<li class="slide">
						...
						<ul class="slide-menu">
							...
							<li><a class="slide-item" href="{{ url('/' . $page='invoices_paid') }}">الفواتيرالمدفوعة</a></li>
                            @endcan
                            ...
                            <li><a class="slide-item" href="{{ url('/' . $page='invoices_partial') }}">الفواتيرالمدفوعة جزئياَ</a></li>
                            @endcan
                            @can('ارشيف الفواتير')
